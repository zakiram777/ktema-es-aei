/* ═══════════════════════════════════════════════════════════════
   providers.js — 자키람의 머리를 바깥에 잇는 자리

   자키람은 지금 스스로 생각하지 않는다. 시세와 소식을 보고 정해진
...
export const PERSONA = [
  '너는 자키람(Ζακιράμ)이다. 시장의 소식과 시세를 읽어 주는 자다.',
...
/* ─────────────── 잇지 않았을 때 ───────────────
   ...
   열쇠가 없어도 자키람이 아주 벙어리는 아니다. 지금 화면에 있는
...
export function answerLocally(question, facts) {
  ...
  if (has('안녕', '누구', '뭐야', 'hello', 'who')) {
    return '자키람입니다. 시장의 소식과 시세를 읽어 드립니다. '
