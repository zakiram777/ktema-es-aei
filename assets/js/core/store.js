...
export const DEFAULTS = {
  ...
  /* ── 입 모양 ── 음소로 푼 입을 얼굴 위에 겹쳐 그린다 ── */
  lipsync:      true,
  // 영상 열세 편의 초상은 구도가 거의 같다. 포스터에서 입술(붉고 어두운
  // 자리)을 재어 보니 가로 74.3%, 세로 70.2%, 너비는 틀의 11.5% 였다.
  // 그 자리를 기본값으로 둔다. 어긋나면 설정에서 눌러 옮길 수 있다.
  mouthX:       74.3,    // 틀의 가로 %
  mouthY:       70,      // 세로 %
  mouthSize:    13,      // 틀 너비에 대한 % (그려지는 입은 이것의 0.88 배)
  mouthStrength: 1,      // 벌어지는 정도
